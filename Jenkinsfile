...
pipeline {
    ...
    parameters {
        string(name: 'GITHUB_REPO', defaultValue: 'https://github.com/YOUR_USERNAME/restoran-takip-sistemi.git', description: 'Repository URL (varsayılan environment üstüne yazar)')
    ...
    environment {
        ...
        GITHUB_REPO = 'https://github.com/YOUR_USERNAME/restoran-takip-sistemi.git'
